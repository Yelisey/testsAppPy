...
from screens.ios.utils.screen_initialization_fixtures import message_screen_object, ios_utils
...
class TestClearSpam(BaseTest):
    ...
    #
    #
    # def test_clear_spam_before_test(self):
    #     self.message_screen_object.clear_folder(
    #         self.get_locator("MessageListScreen", "menu_button"),
    #         self.get_locator("MessageListScreen", "menu_screen_title"),
    #         self.get_locator("MessageListScreen", "clear_spam_from_menu"),
    ...
    #
    #
    # def test_select_emails_and_move_emails_to_spam(self):
    #     self.message_screen_object.select_emails_and_move_to_folder(
    #         self.get_locator("MessageListScreen", "move_to_spam_button"))
    #
    #
    ...
    #         self.get_locator("MessageListScreen", "menu_button"),
    #         self.get_locator("MessageListScreen", "menu_screen_title"),
    #         self.get_locator("MessageListScreen", "spam_folder"),
    #         self.get_locator("MessageListScreen", "spam_screen_title"),
    #         self.get_locator("MessageListScreen", "empty_folder_placeholder"))
    #
    #
    # def test_open_spam_folder(self):
    #     self.message_screen_object.check_folder_is_empty_or_not(
    #         self.get_locator("MessageListScreen", "menu_button"),
    #         self.get_locator("MessageListScreen", "menu_screen_title"),
    #         self.get_locator("MessageListScreen", "spam_folder"),
